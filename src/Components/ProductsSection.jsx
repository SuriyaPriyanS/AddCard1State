...
import ProductCard from "./Products"; // Import the ProductCard component
import "./ProductsSection.css"; // Import the CSS file for styling

const ProductsSection = ({ addToCart, removeFromCart }) => {
  // Sample product data
  const products = [
    {
      id: 1,
